...
export function ScrapbookRow({
  ...
  return (
    <article className="scrapbook-row group relative flex min-w-0 items-center gap-3 rounded-[var(--radius-lg)] bg-surface-raised px-3.5 py-3 transition-colors duration-150 hover:bg-surface-hover focus-within:bg-surface-hover motion-reduce:transition-none">
