...
import { DraggableSurfaceStory } from "./stories/CaptureComponentStories";
...
const catalog = [
  ...
  { id: "chat-empty", label: "Chat empty state" },
  ...
  { id: "draggable-surface", label: "Draggable surface" },
    ...
    <div className={`design-lab ${dark ? "dark" : ""}`}>
      ...
      <main className="design-lab-main">
        ...
        <ComponentSection
          ...
          description="A useful starting point with no invented assistant message or fake response."
        >
          <ChatEmptyStateStory />
        </ComponentSection>
        ...
        <ComponentSection
          id="draggable-surface"
          index="27"
          title="Draggable surface"
          description="Positioning and handle-based movement shared by floating explanation interfaces."
        >
          <DraggableSurfaceStory />
        </ComponentSection>
